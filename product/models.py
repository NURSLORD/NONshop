...
class SubCategory(models.Model):
    ...
    is_active = models.BooleanField(verbose_name='Подтверждённый', default=True)
    image = models.ImageField(verbose_name='Фото', upload_to='Sub/%Y/%m/%d', null=True)
...
class Comment(models.Model):
    product = models.ForeignKey(Product, on_delete=models.SET_NULL, null=True, verbose_name='Продукт', related_name='comments')
